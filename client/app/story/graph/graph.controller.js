...
function updateNode() {
    ...
    $scope.exportPDF = function() {
      ...
      //     source = $('#storyBox')[0]// source can be HTML-formatted string, or a reference to an actual DOM element from which the text will be scraped.
      ...
      //   '#storyBox': function(element, renderer){
